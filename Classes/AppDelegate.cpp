...
static cocos2d::Size mediumResolutionSize = cocos2d::Size(720, 540);
...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("MyCppGame", Rect(0, 0, mediumResolutionSize.width , mediumResolutionSize.height));
#else
